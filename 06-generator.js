...
const it = iterate(['Oscar', 'Nico', 'Sofi', 'Matte', 'Ulises'])

console.log(it.next().value); // accede a la prima position del array recordando su estado
console.log(it.next().value); // second position
